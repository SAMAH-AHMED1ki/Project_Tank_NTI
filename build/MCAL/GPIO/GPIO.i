...
STD_ReturnType GPIO_SetPinValue(uint8 Copy_u8Port, uint8 Copy_u8Pin, uint8 Copy_u8Value)
{
    if (Copy_u8Port > 3u || Copy_u8Pin > 7u || (Copy_u8Value != 1u && Copy_u8Value != 0u))
    {
        return E_NOK;
    }
    if (Copy_u8Value == 1u)
...
STD_ReturnType GPIO_GetPinValue(uint8 Copy_u8Port, uint8 Copy_u8Pin, uint8 *Copy_pu8Value)
{
    ...
    {
    case 0u:
        *Copy_pu8Value = ((((*(volatile uint8 *)0x39)) >> (Copy_u8Pin)) & 1u) ? 1u : 0u;
        break;
    case 1u:
        *Copy_pu8Value = ((((*(volatile uint8 *)0x36)) >> (Copy_u8Pin)) & 1u) ? 1u : 0u;
        break;
    case 2u:
        *Copy_pu8Value = ((((*(volatile uint8 *)0x33)) >> (Copy_u8Pin)) & 1u) ? 1u : 0u;
        break;
    case 3u:
        *Copy_pu8Value = ((((*(volatile uint8 *)0x30)) >> (Copy_u8Pin)) & 1u) ? 1u : 0u;
        break;
    }
    return E_OK;
}
