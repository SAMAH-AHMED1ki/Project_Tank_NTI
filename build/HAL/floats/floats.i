...
STD_ReturnType FLT_Update(void)
{
    ...
    Global_u8HighState = (Local_u8HighRaw == 0u) ? 1u : 0u;
    Global_u8LowState = (Local_u8LowRaw == 0u) ? 1u : 0u;
